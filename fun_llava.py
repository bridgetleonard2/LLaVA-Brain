...
def setup_model(layer='multi_modal_projector.linear_2'):
    ...
    layer_selected = model.multi_modal_projector.linear_2.register_forward_hook(get_features(layer))
...
def get_movie_features(movie, subject, layer, n=30):
    ...
    """
    try:
        data = np.load(f"results/features/movie/{subject}/layer" +
                       f"_{movie}.npy")
        ...
        np.save(f"results/features/movie/{subject}/layer_{movie}.npy",
                data)
...
def get_story_features(story, subject, layer, n=20):
    ...
    try:
        ...
        np.save(f"results/features/story/{subject}/layer_{story}.npy",
                data)
